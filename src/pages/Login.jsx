  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#0A0A0A] relative overflow-hidden p-6">
      ...
      <div className="w-full max-w-md p-10 border border-[#2A2A2A] rounded-none bg-[#121212]/90 backdrop-blur-sm shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden group z-10">
        ...
        <div className="mt-8 text-center">
          <p className="text-xs font-mono text-slate-400">
            ...
            <Link to="/register" className="text-copper hover:text-copper/80 transition-colors underline decoration-copper/30 underline-offset-4">
              Register
            </Link>
          </p>
        </div>
      ...
      <div className="mt-8 flex items-center gap-2 opacity-30 grayscale pointer-events-none">
        ...
        <span className="text-[10px] font-mono uppercase tracking-widest text-slate-500">AES-256 Encrypted Session</span>
      </div>
    </div>
  );
};
